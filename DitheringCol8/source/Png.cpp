...
#include "Format.hpp"
#include "Png.hpp"
#include "../library/lpng/include/pngstruct.h"
#include "../library/lpng/include/pnginfo.h"
...
#ifdef _DEBUG
#ifdef _WIN64
#pragma comment(lib, "./library/zlib/lib/x64/Debug/zlib.lib")
#pragma comment(lib, "./library/lpng/lib/x64/Debug/lpng.lib")
#else
#pragma comment(lib, "./library/zlib/lib/x86/Debug/zlib.lib")
#pragma comment(lib, "./library/lpng/lib/x86/Debug/lpng.lib")
#endif
#else
#ifdef _WIN64
#pragma comment(lib, "./library/zlib/lib/x64/Release/zlib.lib")
#pragma comment(lib, "./library/lpng/lib/x64/Release/lpng.lib")
#else
#pragma comment(lib, "./library/zlib/lib/x86/Release/zlib.lib")
#pragma comment(lib, "./library/lpng/lib/x86/Release/lpng.lib")
#endif
#endif
...
bool Png::Load(void* buffer, size_t buffer_size)
{
	...
	{
		lines[i] = reinterpret_cast<unsigned char*>(workbuffer + static_cast<size_t>(png_width) * i);
	}
